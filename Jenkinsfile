pipeline {
    ...
    environment {
        ...
        APP_REPO_NAME = "phonebook-coy"
        ACR_REGISTRY = "{APP_REPO_NAME}.azurecr.io"
        APP_NAME = "todo"
    ...
    stages {
        ...
        stage('Push Image to ECR Repo') {
            steps {
                ...
                sh 'az acr login --name ${ACR_REGISTRY} --expose-token | docker login --username "$APP_REPO_NAME" --password-stdin "$ACR_REGISTRY"'
        ...
        stage('Deploy the App') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'ec2-user', disableHostKeyChecking: true, installation: 'ansible', inventory: 'inventory_aws_ec2.yml', playbook: 'docker_project.yml'
             }
        }
